...
<body>
  <div class="scrolling-text-container">
    <p class="scrolling-text">Secure Website Register Page</p>

    <div class="register-container">
      <h1>Register</h1>
      <form class="register-form" action="RegisterSPage.php" method="POST">
  ...
  if (empty($username) || empty($password)) {
    ...
    if (mysqli_num_rows($result_check_username) > 0) {
      ...
      if (mysqli_query($conn, $sql)) {
        echo '<script> alert ("Registration successful - you can redirect to the login page or homepage")</script>';
      } else {
